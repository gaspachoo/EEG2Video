...
if __name__ == "__main__":
    ...
    parser.add_argument("--raw_dir",  default = "./data/Preprocessing/Segmented_Rawf_200Hz_2s", help="directory with .npy files") 
    parser.add_argument("--feat_dir", default="./data/Preprocessing/DE_1per1s/", help="directory with .npy files")
    parser.add_argument("--checkpoint_path", default="./EEG2Video/checkpoints/cv_glmnetv2/sub3_fold0_best.pt", help="checkpoint path")
