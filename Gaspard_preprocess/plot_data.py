...
# Load files
raw_data = np.load("./dataset/Segmented_Rawf_200Hz_2s/sub1.npy")   # (7, 40, 5, 62, 400)
de_data = np.load("./dataset/DE_1per2s/1.npy")                     # (1, 40, 5, 62, 5)
psd_data = np.load("./dataset/PSD_1per2s/1.npy")                   # (1, 40, 5, 62, 5)
