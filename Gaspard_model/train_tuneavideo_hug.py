...
from diffusers import AutoencoderKL, PNDMScheduler, UNet3DConditionModel
...
class TuneAVideoTrainer:
    def __init__(self, args):
        ...
        # now using diffusers UNet instead of local model
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Train Tune-A-Video with EEG'
    )
