...
def parse_args():
    ...
    parser.add_argument("--g_ckpt", type=str, default=f"{home}/EEG2Video/Gaspard_model/checkpoints/cv_shallownet/best_fold0.pth", help="Path to ShallowNet checkpoint")
    parser.add_argument("--l_ckpt", type=str, default=f"{home}/EEG2Video/Gaspard_model/checkpoints/cv_mlp_DE/best_fold0.pt", help="Path to MLP checkpoint")
