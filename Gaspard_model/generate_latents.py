...
if __name__ == "__main__":
    ...
    parser.add_argument('--gif_dir', type=str,  default = f"{root}/data/Video_gifs/", help="Directory with .gif files")
    parser.add_argument('--output_path', type=str, default = f"{root}/data/Video_latents/", help="Path to save .npy latents")
